      ...
      <Main>
        ...
        <Flex alignItems="flex-start" flexDirection="column" gap={8}>
          ...
          <TextBlock icon="CallIcon24" title="Телефон">
            <TouchableOpacity style={styles.phone} onPress={() => Linking.openURL("tel:83882220506")}>
              <Typography variant="p">+7(38822)2-05-06</Typography>
            </TouchableOpacity>
            {"\n"}
            <TouchableOpacity style={styles.phone} onPress={() => Linking.openURL("tel:89039192809")}>
              <Typography variant="p">+79039192809</Typography>
            </TouchableOpacity>
            {"\n"}
            <TouchableOpacity style={styles.phone} onPress={() => Linking.openURL("tel:83884423402")}>
